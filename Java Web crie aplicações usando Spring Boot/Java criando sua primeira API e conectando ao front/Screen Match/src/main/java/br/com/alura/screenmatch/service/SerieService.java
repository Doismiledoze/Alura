...
public class SerieService {
    ...
    public List<SerieDTO> obterTodasAsSeries() {
        // return repositorio
        // .findAll().stream().map(s -> new SerieDTO(s.getId(), s.getTitulo(),
    ...
    public List<SerieDTO> obterTop5Series() {
        // return repositorio
        // .findTop5ByOrderByAvaliacaoDesc().stream().map(s -> new SerieDTO(s.getId(),
    ...
    public List<SerieDTO> obterLancamentos() {
        // return
        // converteDados(repositorio.findTop5ByOrderByEpisodiosDataLancamentoDesc());
