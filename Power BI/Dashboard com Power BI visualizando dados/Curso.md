...
- [Buscante](https://app.powerbi.com/view?r=eyJrIjoiZmUzZWU5ZWQtYzBjNy00NjMyLThlYjMtNDM5ZmQwNGM2YzE4IiwidCI6ImNiNTI5NGJlLTY5MGEtNDNhNC04ZWRmLWEwMzIwOWVkODUxNSJ9)
- [Buscante - Execícios Extras](https://app.powerbi.com/view?r=eyJrIjoiYmM4YWM1NWYtN2U2OC00NWJkLTgxNTYtMDNmYmM0OWFjMmNlIiwidCI6ImNiNTI5NGJlLTY5MGEtNDNhNC04ZWRmLWEwMzIwOWVkODUxNSJ9)
...
|------------|-----------
| Resumindo dados | <ul><li>Analisar e importar uma base de dados do Google Sheets através da conexão WEB; </li><li>Identificar o melhor momento para utilizar o visual de cartão;</li><li>Utilizar a versatilidade e as possibilidades desse componente;</li><li>Alterar a função que resume os dados nos cartões;</li><li>Aplicar filtros nos visuais;</li><li>Formatar e personalizar os cartões.</li></ul>
| Visualizando metas e segmentando dados | <ul><li>Escolher um dos melhores visuais para se trabalhar com metas;</li><li>Preencher os campos do visual de indicador e explorar sua formatação;</li><li>Identificar o que é o visual de segmentação de dados e suas variações;</li><li>Construir um filtro com formato de barra deslizante, lista suspensa e lista vertical.</li></ul>
| Construindo tabelas | <ul><li>Trabalhar com tabelas no Power BI; </li><li>Aplicar os cuidados na visualização de tabela;</li><li>Identificar diferenças entre matrizes e tabelas;</li><li>Importar um visual externo para o Power BI;</li><li>Trabalhar com mapa de calor (table heatmap).</li></ul>
| Compreendendo séries temporais | <ul><li>Identificar e trabalhar com séries temporais; </li><li>Utilizar o gráfico de linhas no Power BI;</li><li>Aplicar os múltiplos pequenos para trazer uma análise mais direta em relação à várias categorias;</li><li>Utilizar recursos muito importantes na análise, tais como: tendência e previsão.</li></ul>
| Vendo categorias e localização | <ul><li>Trabalhar com gráficos de colunas e barras; </li><li>Reconhecer as diferenças entre os gráficos empilhados e clusterizados;</li><li>Utilizar os visuais de mapa;</li><li>Formatar a categoria de dados de uma coluna;</li><li>Trabalhar com os conceitos de latitude e longitude dentro do Power BI.</li></ul>
| Construindo o Dashboard | <ul><li>Estruturar o relatório reunindo todos os visuais;</li><li>Formatar os visuais para manter a harmonização do relatório;</li><li>Replicar a formatação entre visuais através do pincel de formatação;</li><li>Navegar entre as páginas através de um botão.</li></ul>
...
| Curso de Apresentação com Power Point | Este curso fornece uma compreensão completa do PowerPoint 2016. Aprenda a criar apresentações elegantes e eficazes para impressionar seus colegas e clientes. | [ACESSAR](https://cursos.alura.com.br/course/apresentacao-power-point)
